...
Keep on mind to first connect all SSH connections manually for verifying and approving the VPS' fingerprint. Check if the forwarded port on the VPS is only bound to localhost.
